...
export default function StockAdjustmentModal({ isOpen, onClose, product, onSuccess }: StockAdjustmentModalProps) {
  ...
  const { register, handleSubmit, formState: { errors }, watch, reset, setValue } = useForm<AdjustmentFormData>({
    defaultValues: {
      ...
      <div className="bg-white rounded-xl w-full max-w-md mx-auto my-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <input
                  type="number"
                  min="1"
                  max={watchAdjustmentType === 'decrease' ? product.quantity : undefined}
                  {...register('quantity', { 
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <h3 className="font-medium text-blue-900 mb-3">Adjustment Preview</h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span>
                      {watchAdjustmentType === 'increase' ? 'Adding:' : 'Removing:'}
                    </span>
                  ...
                  <div className="flex justify-between border-t pt-2">
                    ...
                    <span className="font-bold text-blue-600">{getNewQuantity()}</span>
                  </div>
                </div>
              </div>
            </form>
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-xl sticky bottom-0">
          <div className="flex space-x-3">
            ...
            >
              {loading ? 'Processing...' : `${watchAdjustmentType === 'increase' ? 'Increase' : 'Decrease'} Stock`}
            </button>
          </div>
        </div>
      </div>
